...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2015 at 06:55 PM
...
(1, 'Admin', '(Root)', 1, 0, '#', 'index_index_index', NULL, 1, 'desktop'),
(2, 'Admin', 'Install', 2, 0, '/core/install', '*_*_*', 1, 1, 'wrench'),
(3, 'Admin', 'Menus', 2, 1, '/menus', 'menus_*_*', 1, 1, 'cog'),
(4, 'Admin', 'Roles', 2, 2, '/auth/roles', 'auth_*_*', 1, 1, 'users'),
(5, 'Front', 'Home', 1, 0, '/', 'index_*_*', NULL, 1, 'home'),
(6, 'Admin', 'Exit', 0, 3, '/auth/index/exit', 'auth_index_exit', 1, 1, 'sign-out'),
(7, 'Front', 'Auth', 1, 0, '/auth', 'auth_index_index', 5, 1, 'sign-in'),
(8, 'Front', 'Contact', 1, 2, '/contact', 'index_index_*', 5, 1, 'envelope'),
(9, 'Front', 'Install', 2, 1, '/core/install', 'core_install_*', 5, 1, 'wrench');
